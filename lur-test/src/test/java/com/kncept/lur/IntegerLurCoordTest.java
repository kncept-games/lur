...
public class IntegerLurCoordTest {
    ...
    public void minimalFormReturnsSelfReference() {
        IntegerLurCoord lur1 = new IntegerLurCoord(0, 0, 0);
        Assertions.assertSame(lur1, lur1.toMinimalForm());
        Assertions.assertTrue(lur1.isMinimalForm());

        IntegerLurCoord lur2 = new IntegerLurCoord(0, 3, 5);
        Assertions.assertSame(lur2, lur2.toMinimalForm());
    ...
    public void minimalFormConversion() {
        ...
        Assertions.assertNotEquals(lur1, lur1.toMinimalForm());
        Assertions.assertFalse(lur1.isMinimalForm());
        Assertions.assertEquals(new IntegerLurCoord(0, 1, 1), lur1.toMinimalForm());

        IntegerLurCoord lur2 = new IntegerLurCoord(0, -3, 5);
        Assertions.assertNotEquals(lur2, lur2.toMinimalForm());
        Assertions.assertFalse(lur2.isMinimalForm());
        Assertions.assertNotEquals(new IntegerLurCoord(3, 0, 8), lur2.toMinimalForm());
    }
